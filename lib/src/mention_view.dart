...
class FlutterMentions extends StatefulWidget {
  ...
  static Map<String, Annotation> mapToAnnotation(List<Mention> mentions) {
...
class FlutterMentionsState extends State<FlutterMentions> {
  ...
  @override
  void initState() {
    final data = FlutterMentions.mapToAnnotation(widget.mentions);
  ...
  void didUpdateWidget(widget) {
    ...
    controller!.mapping = FlutterMentions.mapToAnnotation(widget.mentions);
  }
